...
class SearchViewController: UIViewController {
    ...
    func showNetworkError() {
        let alert = UIAlertController(
            ...
            message: NSLocalizedString("There was an error accessing the iTunes Store. Please try again later.", comment: "Error alert message"),
            preferredStyle: .alert
        )
        let action = UIAlertAction(title: NSLocalizedString("OK", comment: "Alert action label"), style: .default)
